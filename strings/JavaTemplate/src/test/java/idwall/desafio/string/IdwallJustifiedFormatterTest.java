...
class IdwallJustifiedFormatterTest {

    @Test
    void format() throws IOException {
        StringFormatter formatter = new IdwallJustifiedFormatter();
        String actual = formatter.format(Main.DEFAULT_INPUT_TEXT);
        String expected = new String(Files.readAllBytes(Paths.get("src","test", "resources", "output-parte2.txt")));
